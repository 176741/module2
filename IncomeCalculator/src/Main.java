...
//вывод сообщений и результатов
            ...
            System.out.println("Общая сумма налогов: " +
                (taxAmount > 0 ? taxAmount : 0));//проверка положительного результата расчета налога и его вывода (в противном случае будет показан 0)
            System.out.println("Компания может инвестировать: " +
                (canMakeInvestments ? "да" : "нет"));//вывод главного результата всей программы
            if(pureIncome < 0) {//проверка чистой прибыли для вывода предупреждения
